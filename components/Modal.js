    ...
    <div>
      <Transition.Root show={open} as={Fragment}>
        <Dialog
          ...
          onClose={setOpen}
        >
          <div className="flex items-center justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sn:p-0">
            {/* Transition.Child is the thing which will be rendered in the screen */}
            <Transition.Child
              as={Fragment}
            ...
            >
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                <div>
                  {selectedFile ? (
                    <img
                      className="w-full onject-contain cursor-pointer"
                      src={selectedFile}
                    ...
                    <div className="mt-3 text-center sm:mt-5">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          type="text"
                          ref={captionRef}
                          placeholder="Please enter a caltion..."
                        />
                      </div>
                    </div>
                  </div>
